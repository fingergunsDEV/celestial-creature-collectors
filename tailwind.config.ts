	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Custom color palette for Celestial Creature Collectors
				celestial: {
					blue: '#8EB8E5',
					purple: '#9E8EC8',
					pink: '#E5A9C2',
			...
			animation: {
				...
				'exit': 'fade-out 0.5s ease-out forwards, scale-out 0.3s ease-out forwards',
			},
			backgroundImage: {
			...
			boxShadow: {
				...
				'glow-celestial': '0 0 15px rgba(142, 184, 229, 0.5)',
			},
			transitionProperty: {
				'height': 'height',
